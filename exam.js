...
function saveResultsToStorage() {
    ...
    let correct = shuffledQuestions.filter((q,i) => userAnswers[i] !== null && q.answers[userAnswers[i]].isCorrect);
    ...
    localStorage.setItem("unansweredQuestions", shuffledQuestions.length - answeredCount);
}
...
async function initExam() {
    ...
    btnSubmit.addEventListener("click", function () { submitExam(); });
